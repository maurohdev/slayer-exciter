...
| 4 | **Rame smaltato 0,20 mm (o 0,25 mm), rocchetto ~50 g** | 6–10 € | negozio elettronica / AliExpress / Amazon | Secondaria — **scelta di Mauro: 0,20 mm** → 304 spire = 28,7 m, f ~1,6–1,8 MHz: serve top load Ø 15–20 cm (β TIP41C 1,7–1,9). La 0,25 mm (249 spire = 23,5 m, f ~2,0 MHz, β ≤ 1,5) è al limite col TIP41C: consigliata SOLO se monti direttamente il BD139. Rotolo 50 g = ~178 m (0,20) / ~114 m (0,25): metratura ampissima, contare le spire a blocchi. |
