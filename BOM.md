...
| 4 | **Tubetti plastica vitamina C** Ø nominale 2,7 cm (reale ~2,9) × 7 cm (ne servono **2**, uniti = 14 cm) | — | — | Supporto della secondaria v1.2.1: è il vincolo geometrico del progetto (500 spire su 14 cm). La giunzione tra i due tubi (stecca interna + nastro, superficie senza gradini) è il punto critico n°1 della bobinatura. |
| 5 | **Stagnola da cucina** (quanta serve per una pallina Ø 12 cm) | 2–3 € | supermercato | **Top load**: capacità terminale (4,0–5,3 pF reali da stagnola) che tiene la risonanza intorno a ~1,65 MHz, dove il BD139 titolare lavora con margine ampio (β ≈ 110–121). Serve una PALLONA accartocciata Ø 12 cm, non un ritaglio. |
...
|---|---|---|---|---|
| 1 | **BD139** (TO-126, NPN 80 V 1,5 A) | 2–3 € | negozio elettronica / AliExpress / Amazon | **Transistor titolare (decreto 11/09)**: fT 190 MHz → a 1,57–1,72 MHz β ≈ 110–121 e commutazione pulita (t_sw ~0,1 µs stimato). Prendine **2–3**: è il componente che può morire durante le prove. ⚠️ Pinout E-C-B (1=Emettitore, 2=Collettore, 3=Base) — diverso dal TIP41C. Datasheet: https://www.st.com/resource/en/datasheet/bd139.pdf · https://www.onsemi.com/pdf/datasheet/bd139-d.pdf |
...
| 4 | **Rame smaltato Ø 0,25 mm, rotolo ~50 g (229 m)** | 6–10 € | negozio elettronica / AliExpress / Amazon | Secondaria — **scelta definitiva v1.2.1**: 500 spire = 45,6 m (+~2,6 m di terminazioni ≈ **48 m totali**), L 1,35 mH → f 1,57–1,72 MHz (top Ø 12 cm reale). Rotolo 229 m: margine **~4,7×**, ~4 riavvolgimenti completi. Verifica multimetro post-bobinatura: **~17–18 Ω**. MAI 0,15/0,20 mm come voce d'acquisto. |
