...
> **⚠️ AGGIORNAMENTO 15/09 — v1.2 (geometria: sovrascrive la v1.1)**: il tubo diventa **Ø 2,7 × 14 cm** (2 tubi da 7 cm uniti con stecca interna + nastro) con **500 spire nominali** (tolleranza 480–500) dello stesso filo 0,25 mm → 42,4 m (+2,6 terminazioni ≈ 45 m, margine ~5× sul rotolo 229 m) → **L2 = 1,18 mH** (Wheeler; l/D 5,19, di poco fuori range 0,4–5, errore atteso 1–5%) → C_med 2,25 pF (Medhurst H = 0,833) + top load **stagnola Ø 12 cm** reale 4,0–5,3 pF → C_tot 6,2–7,5 pF → **f = 1,55–1,85 MHz** (centro ~1,69) → BD139 β ≈ 102–113, **margine avvio ~34–38×**; TIP41C β ≈ 1,6–1,8 = resta escluso. Guadagno d'anello netto ~×1,7 vs v1.1 (avvio più probabile), dissipazione 0,8–1,3 W, R DC attesa 15–16 Ω. Circuito, assorbimento (0,5–0,9 A), fusibile e carrello invariati. Verifica completa della combinazione in [VERIFICA_SISTEMA.md](VERIFICA_SISTEMA.md); procedure meccaniche (giunzione tubi, zavorra, continuità palla) nel manuale.
...
| — | **QUESTO PROGETTO v1.2 (previsione)** | **BD139** | 10 k | **500 spire 0,25 mm, Ø2,7×14 cm (2 tubi uniti)** | 4 spire | 12 V | **1,55–1,85 MHz** (top Ø 12 cm reale) | **0,5–0,9 A** | LED 2–5 cm, neon 5–10 cm; β 102–113, margine avvio ~34–38× | §5 + VERIFICA_SISTEMA |
