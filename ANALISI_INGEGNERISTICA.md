...
> **⚠️ AGGIORNAMENTO 24/09 — v1.2.1 (geometria reale: sovrascrive il Ø della v1.2)**: misura reale del tubo montato: **Ø ≈ 2,9 cm** (il 2,7 era il nominale) × 14 cm (2 tubi da 7 cm uniti con stecca interna + nastro), **500 spire nominali** invariate (tolleranza 480–500) → 45,6 m (+2,6 terminazioni ≈ 48 m, margine ~4,7× sul rotolo 229 m) → **L2 = 1,35 mH** (Wheeler; l/D 4,83 — ora DENTRO range 0,4–5) → C_med 2,31 pF (Medhurst H = 0,797) + top load **stagnola Ø 12 cm** reale 4,0–5,3 pF → C_tot 6,3–7,6 pF → **f = 1,57–1,72 MHz** (centro ~1,65) → BD139 β ≈ 110–121, **margine avvio ~37–40×**; TIP41C β ≈ 1,7–1,9 = resta escluso. Guadagno d'anello netto ~×1,7 vs v1.1 (invariato), dissipazione 0,8–1,3 W (invariata), R DC attesa 17–18 Ω. Circuito, assorbimento (0,5–0,9 A), fusibile e carrello invariati. Verifica completa della combinazione in [VERIFICA_SISTEMA.md](VERIFICA_SISTEMA.md); procedure meccaniche (giunzione tubi, zavorra, continuità palla) nel manuale. Circuito, assorbimento (0,5–0,9 A), fusibile e carrello invariati. Verifica completa della combinazione in [VERIFICA_SISTEMA.md](VERIFICA_SISTEMA.md); procedure meccaniche (giunzione tubi, zavorra, continuità palla) nel manuale.

### 5.2 Induttanza secondaria (formula di Wheeler)

L [µH] = r²·N² / (9r + 10l) con r e l in pollici (r = 0,571 in, l = 5,512 in per il nostro tubo v1.2.1)
...
| — | **QUESTO PROGETTO v1.2.1 (previsione)** | **BD139** | 10 k | **500 spire 0,25 mm, Ø2,9×14 cm reali (2 tubi uniti; nominale 2,7)** | 4 spire | 12 V | **1,57–1,72 MHz** (top Ø 12 cm reale) | **0,5–0,9 A** | LED 2–5 cm, neon 5–10 cm; β 110–121, margine avvio ~37–40× | §5 + VERIFICA_SISTEMA |
